    ...
    <div class="bg-white py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto lg:mx-0 text-center">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl animate-fade-down wow">
            Comentarios de nuestros estudiantes
          </h2>
          <p class="mt-2 text-lg leading-8 text-gray-600 animate-fade-up wow">
        ...
        >
          <article
            v-for="post in posts"
            :key="post.id"
            class="flex max-w-xl flex-col items-start justify-between animate-fade-left wow"
          >
