<template>
    ...
    >
      ...
      <div class="mx-auto max-w-2xl lg:max-w-4xl">
        <h1
          class="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl animate-fade-down wow"
        >
          La Solución para Tu Éxito Universitario
        </h1>
        <figure class="mt-10">
          <blockquote
            class="text-center text-xl font-semibold leading-8 text-gray-900  sm:leading-9 animate-fade-up wow"
          >
            <p>
              “En [Nombre de tu Institución], ofrecemos una solución integral para
              prepararte de manera efectiva para la universidad. Nuestros
              programas académicos de calidad y apoyo personalizado te ayudarán a
